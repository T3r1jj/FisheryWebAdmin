...
app.controller('AddItemController', ['$mdDialog', '$service', '$scope', function ($mdDialog, $service, $scope) {
    'use strict';
    ...
    this.addItem = function () {
        ...
        if ($scope.item.form.$valid) {
            $service.addRsiFishery.save($scope.fishery, success);
        }
    };

}]);
app.controller('FisheriesController', ['$mdDialog', '$q', '$scope', '$timeout', '$service', function ($mdDialog, $q, $scope, $timeout, $service) {
    'use strict';
    ...
    $scope.loadStuff = function () {
        if ($scope.data.selectedIndex === 0) {
            $scope.promise = $service.fisheries.query({countryCode: $scope.country.selected.code}, fisheriesSuccessFetch).$promise;
        } else {
    ...
    $scope.addItem = function (event) {
        $mdDialog.show({
            ...
            focusOnOpen: false,
            targetEvent: event,
            templateUrl: 'templates/fishery-dialog.html'
